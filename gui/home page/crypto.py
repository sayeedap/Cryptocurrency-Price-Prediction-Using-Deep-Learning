...
Label(m3, text="Bitcoin (BTC)",anchor="w",font=("Times", 15, "bold"),pady=15).grid(sticky="W",row=3,column=4)
...
Label(m3,image=logobch).grid(sticky="W",row=6,column=2)
Label(m3, text="Bitcoin Cash (BCH)",justify=LEFT,font=("Times", 15, "bold")).grid(sticky="W",row=6,column=4)
Label(m3, text=response_json['BCH']['USD'],font=("Times", 15, "bold")).grid(sticky="W",row=6,column=6)
...
Label(m3,image=logoada).grid(sticky="W",row=8,column=2)
Label(m3, text="Cardano (ADA)",font=("Times", 15, "bold")).grid(sticky="W",row=8,column=4)
Label(m3, text=response_json['ADA']['USD'],font=("Times", 15, "bold")).grid(sticky="W",row=8,column=6)
