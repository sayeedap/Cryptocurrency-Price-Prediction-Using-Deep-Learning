...
def pred():
        os.system('graph.py')
def prebtc():
        os.system('graphbtc.py')
def graphbtc():
        os.system('pre_btc.py')
def preeth():
        os.system('grapheth.py')
def grapheth():
        os.system('pre_eth.py')
def prexrp():
        os.system('graphxrp.py')
def graphxrp():
        os.system('pre_xrp.py')
def prebch():
        os.system('graphxlm.py')
def graphbch():
        os.system('pre_xlm.py')
def preltc():
        os.system('graphltc.py')
def graphltc():
        os.system('pre_ltc.py')
def preada():
        os.system('graphusdt.py')
def graphada():
        os.system('pre_usdt.py')
def prexmr():
        os.system('graphxmr.py')
def graphxmr():
        os.system('pre_xmr.py')
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=prebtc).grid(sticky="W",row=3,column=8)
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=preeth).grid(sticky="W",row=4,column=8)
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=prexrp).grid(sticky="W",row=5,column=8)
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=prebch).grid(sticky="W",row=6,column=8)
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=preltc).grid(sticky="W",row=7,column=8)
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=preada).grid(sticky="W",row=8,column=8)
...
Button(m3, text="Price Chart",anchor="w",font=("Times", 10, "bold"),padx=15,command=prexmr).grid(sticky="W",row=9,column=8)
